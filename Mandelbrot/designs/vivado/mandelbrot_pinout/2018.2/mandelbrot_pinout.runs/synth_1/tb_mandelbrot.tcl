...
read_vhdl -library xil_defaultlib {
  ...
  /home/xilinx/lpsc_mandelbrot_blazevic/Mandelbrot/designs/vivado/mandelbrot_pinout/2018.2/mandelbrot_pinout.srcs/sources_1/new/tb_mandelbrot.vhd
}
...
synth_design -top tb_mandelbrot -part xc7a200tsbg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef tb_mandelbrot.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file tb_mandelbrot_utilization_synth.rpt -pb tb_mandelbrot_utilization_synth.pb"
