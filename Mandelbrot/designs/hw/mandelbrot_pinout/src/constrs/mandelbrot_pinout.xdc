...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports ClkSys100MhzxCI]
...
## Buttons for reset
#set_property -dict {PACKAGE_PIN B22 IOSTANDARD LVCMOS12} [get_ports { ResetxRI }];
...
#sset_property -dict { PACKAGE_PIN Y4    IOSTANDARD LVCMOS33 } [get_ports { hdmi_rx_scl }]; #IO_L11P_T1_SRCC_34 Sch=hdmi_rx_scl
