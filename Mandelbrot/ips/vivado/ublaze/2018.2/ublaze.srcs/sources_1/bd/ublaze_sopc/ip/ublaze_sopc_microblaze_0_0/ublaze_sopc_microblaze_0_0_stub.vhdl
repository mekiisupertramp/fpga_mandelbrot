...
-- Date        : Fri Feb 22 09:28:32 2019
-- Host        : xps13-debian running 64-bit Debian GNU/Linux 9.8 (stretch)
-- Command     : write_vhdl -force -mode synth_stub -rename_top ublaze_sopc_microblaze_0_0 -prefix
--               ublaze_sopc_microblaze_0_0_ ublaze_sopc_microblaze_0_0_stub.vhdl
-- Design      : ublaze_sopc_microblaze_0_0
...
entity ublaze_sopc_microblaze_0_0 is
  Port ( 
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
...
end ublaze_sopc_microblaze_0_0;

architecture stub of ublaze_sopc_microblaze_0_0 is
...
attribute x_core_info of stub : architecture is "MicroBlaze,Vivado 2018.2.2";
begin
end;
